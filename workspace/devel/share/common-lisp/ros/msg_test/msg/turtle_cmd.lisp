...
(cl:defmethod cl:initialize-instance :after ((m <turtle_cmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'turtle_cmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name msg_test-msg:<turtle_cmd> is deprecated: use msg_test-msg:turtle_cmd instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <turtle_cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msg_test-msg:x-val is deprecated.  Use msg_test-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <turtle_cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msg_test-msg:y-val is deprecated.  Use msg_test-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'theta-val :lambda-list '(m))
(cl:defmethod theta-val ((m <turtle_cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msg_test-msg:theta-val is deprecated.  Use msg_test-msg:theta instead.")
  (theta m))
